...
namespace go.test.sam.reader.test
{
    ...
    {
        //public string testData = "[{ \"id\":\"10\",\"name\":\"User\"}, { \"id\":\"11\",\"name\":\"Group\"}, { \"id\":\"12\",\"name\":\"Permission\"}]";
        ...
        public void testIfFirstRowOfEmptyTableAreReturnedException()
        {
        ...
        [Fact]
        public void testIfFirstRowOfEmptyTableAreReturnedExceptionText()
        {
            string testDataEmpty = "[]";
            DataTable dt = (DataTable)JsonConvert.DeserializeObject(testDataEmpty, (typeof(DataTable)));
